...
@router.delete(
    ...
    description="Deleter next of kin. Cannot delet if it's the only one remaining"
)
async def delete_next_of_kin_route(
    ...
    try:
        ...
        logger.warning(f"Next of kin deletion failed for user: {current_user.email}: {http_ex.detail}")
        raise http_ex
