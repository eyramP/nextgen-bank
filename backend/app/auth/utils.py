...
def verify_passowrd(password: str, hashed_password) -> bool:
    try:
...
def set_auth_cookies(
    ...
    """Configuring logged_in cookie settings"""
...
def delete_auth_cookies(response: Response) -> None:
    """
    Delete access, refresh, and looged_in cookie when user loggs out
