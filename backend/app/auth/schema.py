...
class SecurityQuestionSchema(str, Enum):
    ...
    def get_description(cls, value: "SecurityQuestionSchema") -> str:
        descriptions = {
            ...
            cls.CHILDHOOD_FRIEND: "What is the name of your chilhood friend?",
            cls.FAVORITE_COLOR: "What is the name of the city you were born in?",
            cls.BIRTH_CITY: "Wha is the name of the city you were born in?"
        }
...
class BaseUserSchema(SQLModel):
    ...
    role: RoleChoicesSchema = Field(RoleChoicesSchema.CUSTOMER)
        ...
        if "new_password" in values.data and v != values.data["new_password"]:
            raise HTTPException(
                ...
                detail={
                    "status": "error",
                    "message": "Passwords do not match",
                    "action": "Please make sure the password you entered match"
                }
            )
